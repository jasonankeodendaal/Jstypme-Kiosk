                ...
                <div className="max-w-4xl mx-auto space-y-8 animate-fade-in pb-20">
                    ...
                    <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
                        <div className="flex items-center gap-3 mb-6 pb-4 border-b border-slate-100">
                            ...
                            <h3 className="font-black text-slate-900 uppercase tracking-wider text-sm">Visual Style</h3>
                        </div>
                        <div>
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
                                {['random', 'cinematic', 'pulse', 'static'].map(style => (
                                    <button
                                        ...
                                        className={`p-3 rounded-xl border text-xs font-bold uppercase transition-all ${localData.screensaverSettings?.animationStyle === style || (!localData.screensaverSettings?.animationStyle && style === 'random') ? 'bg-pink-600 text-white border-pink-600 shadow-md' : 'bg-white border-slate-200 text-slate-500 hover:bg-slate-50'}`}
                                    >
                                        {style}
                                    </button>
                                ))}
                            ...
                            <p className="text-[10px] text-slate-400 mt-2 font-medium">
                                Controls how images behave on screen. <strong className="text-slate-600">Cinematic</strong> uses slow pans. <strong className="text-slate-600">Pulse</strong> adds breathing effects.
                            </p>
                        </div>
                    </div>
